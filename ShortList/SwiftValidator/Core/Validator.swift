...
public class Validator {
    ...
    public var validations = OrderedDictionary<UITextField,ValidationRule>()
    /// Dictionary to hold fields (and accompanying errors) that were unsuccessfully validated.
    public var errors = OrderedDictionary<UITextField,ValidationError>()
    ...
    */
    ...
    public func unregisterField(textField:UITextField) {
        validations[textField] = nil
        errors[textField] = nil
    }
    ...
    /**
     ...
     - returns: No return value.
     */
    public func validate(callback:(errors:OrderedDictionary<UITextField,ValidationError>)->Void) -> Void {
